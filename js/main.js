...
/* scroling efect in blog section start*/
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cardWidth = document.querySelector('.blog-card').offsetWidth + 30; // Include gap
    ...
    if (prevBtn && nextBtn && blogGrid) {
        ...
        function updateButtonStates() {
            const isAtStart = blogGrid.scrollLeft <= 0;
...
/* scroling efect in blog section end*/
/* blog section end*/
